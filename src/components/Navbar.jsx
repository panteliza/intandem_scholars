    ...
    <>
      ...
      <nav className="w-full bg-white shadow-md px-6 flex justify-between items-center">
        ...
        <Link to="/">
          <img
            src={logo}
            alt="Intandem Scholars"
            className={`h-[180px] w-[240px] object-contain transition-transform duration-300 hover:scale-110 ${
          ...
          <div className="fixed top-0 left-0 w-[300px] h-full bg-white shadow-lg z-[2] flex flex-col">
            ...
            <div className="flex justify-center items-center py-6">
              <img
                ...
                className="h-[120px] object-contain transition-transform duration-300 hover:scale-110"
              />
            </div>
            <Link
              to="/"
